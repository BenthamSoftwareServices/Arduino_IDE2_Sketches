// In this tutorial, we will learn how to interface an OLED 128 x 64 Graphics SPI bus Display Module with an ESP32 Development Board.
// For more info see: https://www.electronicshub.org/esp32-oled-display/

// Note: The SSD1306 OLED display driver chip has an internal charge-pump, while the SSD1309 has an external one.
// So use the Adafruit_SSD1306.h library as there is no specific one for the SSD1309.
// Info re SSD1306 library is here: https://github.com/adafruit/Adafruit_SSD1306
// How to use info: https://learn.adafruit.com/monochrome-oled-breakouts/arduino-library-and-examples
...
// Set display size e.g. 128x64 or 128x32
#define SCREEN_WIDTH 128
#define SCREEN_HEIGHT 64

// Configure SPI functions to GPIO pins; for pinout see: https://esp32io.com/
#define OLED_MOSI   23
#define OLED_CLK    18
#define OLED_DC     16
#define OLED_CS     5
...
// Load display size and MCU SPI pin data to SSD1306 library
