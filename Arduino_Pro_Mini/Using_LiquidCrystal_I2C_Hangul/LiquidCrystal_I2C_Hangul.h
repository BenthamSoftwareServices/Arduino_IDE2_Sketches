...
private:
  ...
  //'ㅢ'형 인덱싱
  int wcUi[21][2] = {
    { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 8, 0 }, { 8, 1 }, { 8, 20 }, { 0 }, { 0 }, { 13, 4 }, { 13, 5 }, { 13, 20 }, { 0 }, { 0 }, { 18, 20 }, { 0 }
  };
  ...
  //어말자음군 인덱싱
  int wcSSang[28][2] = {
    { 0 }, { 0 }, { 0 }, { 1, 19 }, { 0 }, { 4, 22 }, { 4, 27 }, { 0 }, { 0 }, { 8, 1 }, { 8, 16 }, { 8, 17 }, { 8, 19 }, { 8, 25 }, { 8, 26 }, { 8, 27 }, { 0 }, { 0 }, { 17, 19 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }, { 0 }
  };
};
#endif
